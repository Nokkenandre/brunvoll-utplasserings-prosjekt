...
def switch():
    ...
    if screens := not screens:
        ...
        menuitem_1.bind("<Button-1>", lambda e: mkclone(images[0], 40, 170, 132, 100, 70, 50, 0))
        ...
        menuitem_2.bind("<Button-1>", lambda e: mkclone(images[1], 40, 66, 132, 100, 70, 50, 1))
        ...
        menuitem_3.bind("<Button-1>", lambda e: mkclone(images[2], 40, 280, 132, 100, 70, 50, 2))
        ...
        menuitem_4.bind("<Button-1>", lambda e: mkclone(images[3], 20, 390, 183, 100, 92.5, 50, 3))
        ...
        nextpage.place(relx=0.7, rely=0.7)
